...
namespace gal
{
	...
	namespace vm
	{
		...
		/**
		 * @brief The available number of separate memory categories (8 bits)
		 */
		using memory_categories_type = std::uint8_t;
		constexpr memory_categories_type default_memory_category = 0;
		constexpr auto memory_categories_size	 = 256;
