...
namespace gal::lang::foundation
{
	...
	namespace exception
	{
		...
		public:
			...
			bad_boxed_cast(gal_type_info from, const std::type_info& to, const char* const what) noexcept
				: what_{what},
				  from{from},
				  to{&to} {}

			bad_boxed_cast(const gal_type_info from, const std::type_info& to) noexcept
		...
		{
		public:
			gal_type_info type_to;

			conversion_error(const gal_type_info t, const gal_type_info f, const char* const what) noexcept
