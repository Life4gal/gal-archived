// *******************************************
// copy from https://github.com/skarupke/flat_hash_map/blob/master/bytell_hash_map.hpp
// Note: The following source files have been modified for various reasons. Please visit the above URL to obtain the original source files.
// *******************************************
